...
lbl13.place(relx=0.05, rely=0.48)
...
periodo_selector.place(relx=0.05, rely=0.53)  # Ajusta la posición
# Fin del Apartado Periodo

# Apartado de Periodo Incompleto
