...
def Agregar():
    ...
    insertar_en_orden(Tabla, fecha_incompleto, (fecha_incompleto, desde_incompleto, hasta_incompleto, dias_incompletos, 0, consumo_incompleto_DF, consumoDF_incompleto, " "))
